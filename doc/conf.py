# -*- coding: utf-8 -*-
#
# ParallelAccelerator documentation build configuration file, created by
...
htmlhelp_basename = 'ParallelAcceleratordoc'
...
latex_documents = [
  (master_doc, 'ParallelAccelerator.tex', u'ParallelAccelerator Documentation',
   u'Intel Labs', 'manual'),
]
...
man_pages = [
    (master_doc, 'parallelaccelerator', u'ParallelAccelerator Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ParallelAccelerator', u'ParallelAccelerator Documentation',
   author, 'ParallelAccelerator', 'One line description of project.',
   'Miscellaneous'),
]
